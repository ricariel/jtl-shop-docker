...
{include file='../../../Evo/checkout/inc_billing_address_form.tpl'}
{if !$editRechnungsadresse}
    ...
    {/if}
    <div id="create_account_data" class="row collapse {if !isset($checkout)}in{else}hidden{/if} collapse-non-validate" aria-expanded="true">
        <div class="col-xs-6">
